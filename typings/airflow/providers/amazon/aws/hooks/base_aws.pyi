...
"""
BaseAwsConnection = TypeVar("BaseAwsConnection", bound=Union[BaseClient, ServiceResource])
if TYPE_CHECKING:
    ...
else:
    ...
...
class BaseSessionFactory(LoggingMixin):
    ...
    """
    def __init__(self, conn: Connection | AwsConnectionWrapper | None, region_name: str | None = ..., config: Config | None = ...) -> None:
        ...
    ...
    def create_session(self, deferrable: bool = ...) -> boto3.session.Session | AioSession:
...
class AwsGenericHook(BaseHook, Generic[BaseAwsConnection]):
    ...
    conn_type = ...
    hook_name = ...
    def __init__(self, aws_conn_id: str | None = ..., verify: bool | str | None = ..., region_name: str | None = ..., client_type: str | None = ..., resource_type: str | None = ..., config: Config | dict[str, Any] | None = ...) -> None:
        ...
    ...
    def get_session(self, region_name: str | None = ..., deferrable: bool = ...) -> boto3.session.Session:
        """Get the underlying boto3.session.Session(region_name=region_name)."""
        ...
    
    def get_client_type(self, region_name: str | None = ..., config: Config | None = ..., deferrable: bool = ...) -> boto3.client:
        """Get the underlying boto3 client using boto3 session."""
        ...
    
    def get_resource_type(self, region_name: str | None = ..., config: Config | None = ...) -> boto3.resource:
    ...
    @staticmethod
    def retry(should_retry: Callable[[Exception], bool]): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
    def test_connection(self): # -> tuple[Literal[False], str] | tuple[Literal[True], str]:
        """
    ...
    def get_waiter(self, waiter_name: str, parameters: dict[str, str] | None = ..., config_overrides: dict[str, Any] | None = ..., deferrable: bool = ..., client=...) -> Waiter:
        """
