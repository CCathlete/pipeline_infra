...
class AwsConnectionWrapper(LoggingMixin):
    ...
    def get_service_endpoint_url(self, service_name: str, *, sts_connection_assume: bool = ..., sts_test_connection: bool = ...) -> str | None:
        ...
    ...
    @classmethod
    def from_connection_metadata(cls, conn_id: str | None = ..., login: str | None = ..., password: str | None = ..., extra: dict[str, Any] | None = ...): # -> Self:
        """
